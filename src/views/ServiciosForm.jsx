...
// Comprueba si el HTML del editor tiene contenido real
                ...
                <div className="bg-white shadow-lg border border-slate-200 rounded-xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div className="lg:col-span-2 space-y-2">
                                ...
                                <input
                                    ...
                                    placeholder="Ej: Diseño web, SEO, Marketing Digital"
                                    value={title}
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                type="text"
                                className="w-full border border-slate-300 p-3 rounded-lg focus:border-red-600 focus:ring-2 focus:ring-red-600/20 transition-all duration-200 bg-white"
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex gap-3">
                                <input
                                    ...
                                    placeholder="Ej: Diseño, Branding, React..."
                                    value={tagsInput}
